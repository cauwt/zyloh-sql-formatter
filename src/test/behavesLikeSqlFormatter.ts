...
import supportsIdentifierCase from './options/identifierCase';
...
import supportsFunctionCase from './options/functionCase';
import supportsDisableComment from './features/disableComment';
