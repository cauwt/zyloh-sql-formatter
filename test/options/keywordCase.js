...
exports.default = supportsKeywordCase;
const dedent_js_1 = __importDefault(require("dedent-js"));
function supportsKeywordCase(format) {
    ...
    it('formats multi-word reserved clauses into single line', () => {
        const result = format(`select * from mytable
      inner
      join
      ...
      order
      by
      mytable2.col3;`, { keywordCase: 'upper' });
        expect(result).toBe((0, dedent_js_1.default) `
      SELECT
        *
      FROM
...
//# sourceMappingURL=keywordCase.js.map