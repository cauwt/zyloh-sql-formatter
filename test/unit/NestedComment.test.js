...
const NestedComment_js_1 = require("../../src/lexer/NestedComment.js");
describe('NestedComment', () => {
    const match = (input, index) => {
        const re = new NestedComment_js_1.NestedComment();
        re.lastIndex = index;
...
//# sourceMappingURL=NestedComment.test.js.map